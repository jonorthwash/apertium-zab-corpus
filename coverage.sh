...
echo "        & Tlalocan poems \\& story\\footnotemark{} & Simple & $SimpTltoks & $(printf %.2f $SimpTlcov) \\\\"
echo "        & & Individualised & $DictTltoks & $(printf %.2f $DictTlcov) \\\\"
echo "        & \\emph{Niny Bac}\\footnoteref{fn:munroetal} & Simple & $NinyBactoks & $(printf %.2f $NinyBaccov) \\\\"
echo "        & \\emph{Liaza Chaa}\\footnotemark{} & Simple & $LiazaChaatoks & $(printf %.2f $LiazaChaacov) \\\\"
